...
insert into snsboard values(seq_table.nextval,'개나리','코딩 힘드네요','너무 어려운것같아요',sysdate);
insert into snsboard values(seq_table.nextval,'진달래','집가고싶어요','살려주세요',sysdate);
insert into snsboard values(seq_table.nextval,'장미','놀고싶어요','뭐하고 놀지 추천좀요',sysdate);
insert into snsboard values(seq_table.nextval,'튤립','ㅁ','ㅁ1',sysdate);
insert into snsboard values(seq_table.nextval,'코끼리','ㅂ','ㅂ1',sysdate);
insert into snsboard values(seq_table.nextval,'기린','ㅅ','ㅅ1',sysdate);
insert into snsboard values(seq_table.nextval,'원숭이','ㄹ','ㄹ1',sysdate);
insert into snsboard values(seq_table.nextval,'고릴라','ㅎ','ㅎ1',sysdate);
insert into snsboard values(seq_table.nextval,'호랑이','ㅈ','ㅈ1',sysdate);
insert into snsboard values(seq_table.nextval,'사자','ㄹ','ㄹ1',sysdate);
commit;

select b_num 번호,nick 닉네임,subject 제목,content 내용,wday 현재시간
from snsboard;

select b_num 번호,nick 닉네임,subject 제목,content 내용,wday 현재시간 from snsboard;
...
insert into myshop values(seq1.nextval,'아이폰14',3,90000,sysdate);
insert into myshop values(seq1.nextval,'아이폰13',2,80000,sysdate);
insert into myshop values(seq1.nextval,'아이패드',4,90000,sysdate);
insert into myshop values(seq1.nextval,'에어팟',3,60000,sysdate);
insert into myshop values(seq1.nextval,'애플펜슬',7,30000,sysdate);
insert into myshop values(seq1.nextval,'아이폰12',1,70000,sysdate);
insert into myshop values(seq1.nextval,'모니터',3,20000,sysdate);
insert into myshop values(seq1.nextval,'마우스',2,50000,sysdate);
insert into myshop values(seq1.nextval,'헤드셋',9,40000,sysdate);
insert into myshop values(seq1.nextval,'갤럭시탭',1,90000,sysdate);
commit;
