				...
				<caption align="top"><b>회원가입</b></caption>
				  <tr>
				     <td rowspan="6" align="center" style="width: 250px;">
				       <input type="file" id="myphoto" name="myphoto" style="display: none;" class="form-control">
				  ...
				  <tr>
				  	<td>
				  	  <input type="text"  class="form-control" name="name"  placeholder="이름" required="required" style="width: 150px;">	
				  	</td>
				  </tr>
				  <tr>
				  	<td>
				  	  <input type="text"  class="form-control" name="email"  placeholder="이메일" required="required" style="width: 250px;">	
				  	</td>
				  </tr>
				  <tr>
				  	<td>
				  	  <input type="text"  class="form-control" name="hp"  placeholder="전화번호" required="required" style="width: 250px;">	
				  	</td>
				  </tr>
				  <tr>
				  	<td colspan="2">
				  	  <input type="text"  class="form-control" name="addr"  placeholder="주소입력" required="required" style="width: 300px;">	
				  	</td>
				  </tr>
				  <tr>
