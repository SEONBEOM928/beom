...
<div style="margin: 20px 100px; width: 900px;">
	<h5 class="alert alert-info">총 ${totalCount }개의 글이 있습니다</h3>
	<br>
	
	<!-- 글쓰기는 로그인을 해야보임 -->
	<c:if test="${sessionScope.loginok!=null }">
	<button type="button" class="btn btn-info"
	onclick="location.href='list?searchcolumn=id&searchword=${sessionScope.myid}'" style="float: right;">내가쓴글</button>

	<button type="button" class="btn btn-info"
	onclick="location.href='form'" style="float: right;">글쓰기</button><br><br>
	</c:if>
