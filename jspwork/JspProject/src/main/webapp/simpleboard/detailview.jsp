...
<div style="margin: 30px 30px; width: 500px;">
  <table class="table table-bordered">
    <caption align="top"><h3><b><%=dto.getSubject() %></b></h3></caption>
    <tr>
      <td>
    ...
    <tr>
      <td>
        ...
        onclick="location.href='addform.jsp'"><i class="bi bi-pen"></i>글쓰기</button>
        <button type="button" class="btn btn-outline-success"
        ...
        <button type="button" class="btn btn-outline-success"
        onclick="location.href='deletepassform.jsp?num=<%=dto.getNum()%>'"><i class="bi bi-eraser"></i>삭제</button>
      </td>
    </tr>
  </table>
</div>
