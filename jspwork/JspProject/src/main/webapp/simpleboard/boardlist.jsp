...
<body>
  ...
  <ul class="pagination justify-content-center">
    ...
    <%
      ...
      {%>
    	   <li>
    	   <a class="page-link" href="boardlist.jsp?currentPage=<%=startPage-perBlock%>" tabindex="-1" aria-disabled="true">이전</a>
    	   </li>
      <%}
   		...
   		%>
   		   ...
   		   {%>
   		   <li>
    	   <a class="page-link" href="boardlist.jsp?currentPage=<%=endPage+1%>" tabindex="+1" aria-disabled="true">다음</a>
    	   </li>
   			<%}
    		%>
