...
<form action="guest/addproc.jsp" method="post" enctype="multipart/form-data">
	<table class="table table-bordered" style="width: 600px;">
		...
		<i class="bi bi-camera fs-3 camera" style="width:32px; height:32px;"></i>	
		...
		<tr height="100">
			<td width="520">
				<textarea style="width: 500px; height: 150px;" name="content" required="required" class="form-control"></textarea>
			</td>
			<td>
